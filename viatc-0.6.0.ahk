...
; MSWord ===================================
; ==========================================
RegisterHotkey("H","j","<Down>","OpusApp")
RegisterHotkey("H","k","<Up>","OpusApp")
RegisterHotkey("H","h","<Left>","OpusApp")
RegisterHotkey("H","l","<Right>","OpusApp")
